...
(function(exports) {
  ...
  var view = function (model) {
      return Bonsai_Html_Internal.render(Bonsai_Html_Elements.div_(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Bonsai_Html_Internal.text(Data_Show.show(Data_Show.showInt)(model)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Bonsai_Html_Internal.withAttribute(Bonsai_Html_Internal.hasAttributeMarkupF)(Bonsai_Html_Elements.button)(Bonsai_Html_Events.onClick(Inc.value))(Bonsai_Html_Internal.text("+")))(function () {
              return Bonsai_Html_Internal.withAttribute(Bonsai_Html_Internal.hasAttributeMarkupF)(Bonsai_Html_Elements.button)(Bonsai_Html_Events.onClick(Dec.value))(Bonsai_Html_Internal.text("-"));
          });
      })));
  };
  var update = function (model) {
      return function (msg) {
          return Bonsai_Core.plainResult((function () {
              ...
              throw new Error("Failed pattern match at Examples.Basic.Counter line 22, column 3 - line 28, column 1: " + [ msg.constructor.name ]);
          })());
      };
  };
  var main = function __do() {
      var v = Bonsai_DOM.domElementById("examplesBasicCounter")();
      ...
      return __unused()((function () {
          if (v instanceof Data_Maybe.Just) {
              return function __do() {
                  var v1 = Bonsai_Core.program(v.value0)(update)(view)(0)();
                  return Data_Unit.unit;
              };
          };
          throw new Error("Failed pattern match at Examples.Basic.Counter line 36, column 3 - line 36, column 69: " + [ v.constructor.name ]);
      })())();
  };
  exports["Inc"] = Inc;
  exports["Dec"] = Dec;
  ...
  exports["view"] = view;
})(PS["Examples.Basic.Counter"] = PS["Examples.Basic.Counter"] || {});
PS["Examples.Basic.Counter"].main();
