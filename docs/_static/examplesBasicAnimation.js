...
(function(exports) {
  ...
  var readerTask = TaskCmd.create;
  var pureCommand = function (msg) {
      return new Cmd([ msg ]);
  };
  var mapTask = function (f) {
      return function (ta) {
          return function (contextB) {
              var emitA = function (as) {
                  return contextB.emitter(Data_Functor.map(Data_Functor.functorArray)(f)(as));
              };
              var contextA = (function () {
                  var $4 = {};
                  for (var $5 in contextB) {
                      if ({}.hasOwnProperty.call(contextB, $5)) {
                          $4[$5] = contextB[$5];
                      };
                  };
                  $4.emitter = emitA;
              ...
              return Data_Functor.map(Control_Monad_Aff.functorAff)(Data_Functor.map(Data_Functor.functorArray)(f))(ta(contextA));
          };
      };
  };
  var f2cmd = function (cmdFn) {
      return function (fa) {
          var v = Control_Monad_Except.runExcept(fa);
          if (v instanceof Data_Either.Left) {
              return Data_Either.Left.create(Control_Monad_Eff_Exception.error(Data_Foldable.intercalate(Data_List_Types.foldableNonEmptyList)(Data_Monoid.monoidString)(", ")(Data_Functor.map(Data_List_Types.functorNonEmptyList)(Data_Foreign.renderForeignError)(v.value0))));
          };
          if (v instanceof Data_Either.Right) {
              return Data_Either.Right.create(cmdFn(v.value0));
          };
          throw new Error("Failed pattern match at Bonsai.Types line 121, column 3 - line 125, column 22: " + [ v.constructor.name ]);
      };
  };
  var emptyCommand = new Cmd([  ]);
  var cmdFunctor = new Data_Functor.Functor(function (f) {
      return function (v) {
          if (v instanceof Cmd) {
              return Cmd.create(Data_Functor.map(Data_Functor.functorArray)(f)(v.value0));
          };
          if (v instanceof TaskCmd) {
              return TaskCmd.create(mapTask(f)(v.value0));
          };
          throw new Error("Failed pattern match at Bonsai.Types line 54, column 1 - line 54, column 41: " + [ f.constructor.name, v.constructor.name ]);
      };
  });
  exports["Cmd"] = Cmd;
  ...
  exports["f2cmd"] = f2cmd;
  exports["pureCommand"] = pureCommand;
...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];
  var Unsafe_Coerce = PS["Unsafe.Coerce"];        
  var domRequestAnimationFrame = function (eff) {
      return function __do() {
          var v = DOM_HTML.window();
          return DOM_HTML_Window.requestAnimationFrame(eff)(v)();
      };
  };
  var domElementById = function (id) {
      return function __do() {
          var $10 = Control_Bind.bind(Control_Monad_Eff.bindEff)(DOM_HTML.window)(DOM_HTML_Window.document)();
          return DOM_Node_NonElementParentNode.getElementById(id)(DOM_Node_Types.documentToNonElementParentNode(DOM_HTML_Types.htmlDocumentToDocument($10)))();
      };
  };
  exports["domElementById"] = domElementById;
  exports["domRequestAnimationFrame"] = domRequestAnimationFrame;
...
(function(exports) {
  ...
  var property = function (key) {
      return function (value) {
          return $foreign.propertyFn2(key, Data_Foreign.toForeign(value));
      };
  };                                                                 
  ...
  var render = Data_Function_Uncurried.runFn3($foreign.renderFn3)(cmdMap);
  var applyPatches = function (emitter) {
      return function (dnode) {
          return function (vnode) {
              return function (patch) {
                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)($foreign.applyPatchesFn5(cmdMap, emitter, dnode, vnode, patch));
              };
          };
      };
  };
...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];
  var Unsafe_Coerce = PS["Unsafe.Coerce"];        
  var unsafeCoerceCmd = function (cmd) {
      return Unsafe_Coerce.unsafeCoerce(cmd);
  };
  var queueMessages = function (env) {
      return function (msgs) {
          var $20 = Data_Array["null"](msgs);
          if ($20) {
              return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit);
          };
          return function __do() {
              Bonsai_Debug.debugJsonObj(env.dbgEvents)("queue messages:")(msgs)();
              Control_Monad_Eff_Ref.modifyRef(env.pending)(function (pending) {
  ...
  var plainResult = function (model) {
      return {
          model: model, 
          cmd: Bonsai_Types.emptyCommand
      };
  };
  var emitMessages = function (ctx) {
      return function (msgs) {
          return Control_Monad_Aff_Unsafe.unsafeCoerceAff(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(ctx.emitter(msgs)));
      };
  };
  ...
  var updateModel = function (env) {
      var applyMessages = function (v) {
          return function (v1) {
              if (v1.length === 0) {
                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(new Data_Tuple.Tuple(v.value0, v.value1));
              };
              return (function (dictPartial) {
                  var msg = Data_Array_Partial.head(dictPartial)(v1);
                  return function __do() {
                      Bonsai_Debug.debugJsonObj(env.dbgEvents)("message event:")(msg)();
                      var v2 = env.updater(v.value1)(msg);
                      return applyMessages(new Data_Tuple.Tuple(Data_Array.snoc(v.value0)(v2.cmd), v2.model))(Data_Array_Partial.tail(dictPartial)(v1))();
                  };
              })();
          };
      };
      return function __do() {
          var v = Control_Monad_Eff_Class.liftEff(Control_Monad_Eff_Class.monadEffEff)(Control_Monad_Eff_Ref["modifyRef'"](env.pending)(function (ms) {
              return {
                  state: [  ], 
                  value: ms
              };
          }))();
          var $34 = Data_Array["null"](v);
          if ($34) {
              return Data_Unit.unit;
          };
          var v1 = Control_Monad_Eff_Class.liftEff(Control_Monad_Eff_Class.monadEffEff)(Control_Monad_Eff_Ref.readRef(env.state))();
          var v2 = applyMessages(new Data_Tuple.Tuple([  ], v1.model))(v)();
          Control_Monad_Eff_Ref.writeRef(env.state)((function () {
              var $37 = {};
              for (var $38 in v1) {
          ...
          Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(v2.value0)(function ($64) {
              return queueCommand(env)(unsafeCoerceCmd($64));
          })();
  ...
  var updateAndRedraw = function (env) {
      return function __do() {
          updateModel(env)();
          var v = Bonsai_DOM.domRequestAnimationFrame(redrawModel(env))();
          return Data_Unit.unit;
      };
  };
  var redrawModel = function (env) {
      return function __do() {
          var v = Control_Monad_Eff_Class.liftEff(Control_Monad_Eff_Class.monadEffEff)(Control_Monad_Eff_Ref.readRef(env.state))();
          if (v.dirty) {
              var v1 = Bonsai_Debug.startTiming();
              var vnode2 = env.renderer(v.model);
              var patch = Bonsai_VirtualDom.diff(v.vnode)(vnode2);
              var v2 = Control_Monad_Eff_Class.liftEff(Control_Monad_Eff_Class.monadEffEff)(Bonsai_VirtualDom.applyPatches(emitter(env))(v.dnode)(v.vnode)(patch))();
              Bonsai_Debug.debugTiming(env.dbgTiming)("render/diff/applyPatches")(v1)();
              return Control_Monad_Eff_Ref.writeRef(env.state)((function () {
                  var $46 = {};
                  for (var $47 in v) {
  ...
  var queueCommand = function (env) {
      return function (cmd) {
          ...
          var emitTheTypeIsALie = function (env2) {
              return function (msgs) {
                  return Control_Monad_Eff_Unsafe.unsafeCoerceEff(emitSuccess(env2)(msgs));
              };
          };
          ...
          if (cmd instanceof Bonsai_Types.TaskCmd) {
              var ctx = {
                  emitter: emitTheTypeIsALie(env)
              };
              var aff = cmd.value0(ctx);
              return function __do() {
                  var v = Control_Monad_Aff.runAff(emitError)(emitSuccess(env))(Control_Monad_Aff_Unsafe.unsafeCoerceAff(aff))();
                  return false;
              };
          };
          throw new Error("Failed pattern match at Bonsai.Core line 175, column 3 - line 182, column 17: " + [ cmd.constructor.name ]);
      };
  };
  var emitter = function (env) {
      return function (ecmd) {
          if (ecmd instanceof Data_Either.Left) {
              return Control_Apply.applySecond(Control_Monad_Eff.applyEff)(emitError(ecmd.value0))(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(true));
          };
          if (ecmd instanceof Data_Either.Right) {
              return function __do() {
                  var v = queueCommand(env)(unsafeCoerceCmd(ecmd.value0))();
                  if (v) {
                      return Control_Apply.applySecond(Control_Monad_Eff.applyEff)(updateAndRedraw(env))(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(false))();
                  };
                  return false;
              };
          };
          throw new Error("Failed pattern match at Bonsai.Core line 205, column 3 - line 212, column 24: " + [ ecmd.constructor.name ]);
      };
  };
  ...
  var debugProgram = function (container) {
      return function (dbgTiming) {
          return function (dbgEvents) {
                  ...
                  return function (renderer) {
                      return function (model) {
                          ...
                          return function __do() {
                              ...
                              var dnode = Bonsai_VirtualDom.render(emitter(env))(vnode);
                              var v3 = DOM_Node_Node.appendChild(DOM_Node_Types.elementToNode(dnode))(DOM_Node_Types.elementToNode(container))();
                              Bonsai_Debug.debugTiming(env.dbgTiming)("render/appendChild")(v2)();
                              Control_Monad_Eff_Ref.modifyRef(v)(function (state) {
                                  var $61 = {};
                                  for (var $62 in state) {
  ...
  var program = function (container) {
      return function (updater) {
          return function (renderer) {
              return function (model) {
                  return debugProgram(container)(false)(false)(updater)(renderer)(model);
              };
          };
      };
  };
  ...
  exports["plainResult"] = plainResult;
...
(function(exports) {
  ...
  var Data_Unit = PS["Data.Unit"];
  var Prelude = PS["Prelude"];        
  var targetValueEvent = function (event) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Data_Foreign_Index.ix(Data_Foreign_Index.indexableExceptT)(Data_Foreign_Index.indexString)(Data_Foreign_Index.ix(Data_Foreign_Index.indexableForeign)(Data_Foreign_Index.indexString)(event)("target"))("value"))(Data_Foreign.readString);
  };
  exports["targetValueEvent"] = targetValueEvent;
})(PS["Bonsai.EventDecoder"] = PS["Bonsai.EventDecoder"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var Data_List = PS["Data.List"];
...
(function(exports) {
  ...
  var withOptionalStyle = function (dictHasStyle) {
      return function (elem) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Bonsai.Html.Internal line 189, column 1 - line 194, column 7: " + [ elem.constructor.name, v.constructor.name ]);
          };
      };
  };
  ...
  var render = function (elem) {
      ...
      var singleNode = function (ns) {
          var v = Data_Array.fromFoldable(Data_Foldable.foldableArray)(ns);
          if (v.length === 0) {
          ...
          return Bonsai_VirtualDom.node("div")([  ])(v);
      };
      ...
      var foldMarkupF = function (v) {
          ...
          if (v instanceof ElementF) {
              ...
              var a = (function () {
                  var $23 = Data_CatList["null"](v.value0.styles);
                  if ($23) {
                      return v.value0.attribs;
                  };
                  return Data_CatList.snoc(v.value0.attribs)(Bonsai_VirtualDom.style(Data_Array.fromFoldable(Data_CatList.foldableCatList)(styles2Tups(v.value0.styles))));
              })();
              return Control_Monad_State_Class.state(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(function (acc) {
          ...
          throw new Error("Failed pattern match at Bonsai.Html.Internal line 233, column 5 - line 233, column 65: " + [ v.constructor.name ]);
      };
      return singleNode(renderNodes(elem));
  };
          ...
          var go = function (v) {
              if (v instanceof ElementF) {
                  return new ElementF((function () {
                      ...
                      $27.styles = Data_CatList.snoc(v.value0.styles)(st);
                      return $27;
                  })(), v.value1);
              };
              return v;
          ...
          var go = function (v) {
              if (v instanceof ElementF) {
                  return new ElementF((function () {
                      ...
                      $33.attribs = Data_CatList.snoc(v.value0.attribs)(prop);
                      return $33;
                  })(), v.value1);
              };
              return v;
...
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var Bonsai_EventDecoder = PS["Bonsai.EventDecoder"];
  var Bonsai_Types = PS["Bonsai.Types"];
  var Bonsai_VirtualDom = PS["Bonsai.VirtualDom"];
  var Control_Monad_Except_Trans = PS["Control.Monad.Except.Trans"];
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
  ...
  var onInput = function (f) {
      return Bonsai_VirtualDom.on("input")(function ($17) {
          return Bonsai_Types.f2cmd(Bonsai_Types.pureCommand)(Data_Functor.map(Control_Monad_Except_Trans.functorExceptT(Data_Identity.functorIdentity))(f)(Bonsai_EventDecoder.targetValueEvent($17)));
      });
  };
  var onClick = function (msg) {
      return Bonsai_VirtualDom.on("click")(function (v) {
          return Data_Either.Right.create(Bonsai_Types.pureCommand(msg));
      });
  };
...
(function(exports) {
  ...
  var EndAnimation = (function () {
      ...
      EndAnimation.value = new EndAnimation();
      return EndAnimation;
  })();
  var update = function (model) {
      return function (msg) {
          return Bonsai_Core.plainResult((function () {
              if (msg instanceof SetText) {
                  var $11 = {};
                  for (var $12 in model) {
              ...
              if (msg instanceof Animate) {
                  ...
                  $15.color = new Data_Maybe.Just(msg.value0);
                  return $15;
              };
              if (msg instanceof EndAnimation) {
                  var $19 = {};
                  for (var $20 in model) {
                  ...
                  $19.color = Data_Maybe.Nothing.value;
                  return $19;
              };
              throw new Error("Failed pattern match at Examples.Basic.Animation line 62, column 5 - line 68, column 34: " + [ msg.constructor.name ]);
          })());
      };
  };
  var emptyModel = {
  ...
  var animate = function (ctx) {
      var animateColor = function (x) {
          var s = Data_Int.toStringAs(Data_Int.hexadecimal)(x);
          var css = "#FFFF" + (s + "F");
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Bonsai_Core.emitMessages(ctx)([ new Animate(css) ]))(function () {
              return Control_Monad_Aff.delay(200.0);
          });
      };
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Data_Foldable.for_(Control_Monad_Aff.applicativeAff)(Data_Foldable.foldableArray)(Data_Array.range(8)(15))(animateColor))(function () {
          return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)([ EndAnimation.value ]);
      });
  };
  var view = function (m) {
      return Bonsai_Html_Internal.render(Bonsai_Html_Elements.div_(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Bonsai_Html_Internal.withAttribute(Bonsai_Html_Internal.hasAttributeMarkup)(Bonsai_Html_Internal.withAttribute(Bonsai_Html_Internal.hasAttributeMarkup)(Bonsai_Html_Elements.input)(Bonsai_Html_Events.onInput(SetText.create)))(Bonsai_Html_Attributes.value(m.text)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Bonsai_Html_Internal.withOptionalStyle(Bonsai_Html_Internal.hasStyleMarkupF)(Bonsai_Html_Elements.p)(Data_Functor.map(Data_Maybe.functorMaybe)(function (v) {
              return Bonsai_Html_Attributes.style("background-color")(v);
          })(m.color))(Bonsai_Html_Internal.text(m.text)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Bonsai_Html_Internal.withAttribute(Bonsai_Html_Internal.hasAttributeMarkupF)(Bonsai_Html_Elements.button)(Bonsai_Html_Events.onClick(new Animate("#FF0000")))(Bonsai_Html_Internal.text("Red")))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Bonsai_Html_Internal.withAttribute(Bonsai_Html_Internal.hasAttributeMarkupF)(Bonsai_Html_Elements.button)(Bonsai_Html_Events.onClick(new Animate("#00FF00")))(Bonsai_Html_Internal.text("Green")))(function () {
                      return Bonsai_Html_Internal.withAttribute(Bonsai_Html_Internal.hasAttributeMarkupF)(Bonsai_Html_Elements.button)(Bonsai_VirtualDom.on("click")(Data_Function["const"](Control_Applicative.pure(Data_Either.applicativeEither)(Bonsai_Types.readerTask(animate)))))(Bonsai_Html_Internal.text("Animate"));
                  });
              });
          });
      })));
  ...
  var main = function __do() {
      var v = Bonsai_DOM.domElementById("examplesBasicAnimation")();
      ...
      return __unused()((function () {
          if (v instanceof Data_Maybe.Just) {
              return function __do() {
                  var v1 = Bonsai_Core.program(v.value0)(update)(view)(emptyModel)();
                  return Data_Unit.unit;
              };
          };
          throw new Error("Failed pattern match at Examples.Basic.Animation line 77, column 3 - line 77, column 67: " + [ v.constructor.name ]);
      })())();
  };
  exports["Color"] = Color;
  ...
  exports["view"] = view;
})(PS["Examples.Basic.Animation"] = PS["Examples.Basic.Animation"] || {});
PS["Examples.Basic.Animation"].main();
